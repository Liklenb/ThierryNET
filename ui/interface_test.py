...
class FletGraphInterface:
    ...
    def __init__(self, page):
        ...
        # self.page.overlay.append(ft.FilePicker(on_result=lambda e: self.graph.save_to_file(e.path + ".thierry"), ref=save_picker))
    ...
    def _create_graph_ui(self, graph):
        ...
        self.page.views.append(
            ft.View(
                ...
                #     icon=ft.icons.SAVE_ROUNDED
                # ),
                # floating_action_button_location=ft.FloatingActionButtonLocation.END_TOP,
            )
        )
